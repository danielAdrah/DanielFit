...
class AddFavoriteExercise extends StatefulWidget {
  const AddFavoriteExercise({super.key});

  @override
  State<AddFavoriteExercise> createState() => _AddFavoriteExerciseState();
}

class _AddFavoriteExerciseState extends State<AddFavoriteExercise> {
